"""Unified build and validation system for configured Ant Stack papers. Moved verbatim from scripts/common_pipeline/unified_build.py; thin wrapper retained for CLI compatibility."""
