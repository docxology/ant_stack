#!/usr/bin/env python3
"""Generate all tables and numerical content for the manuscript. Moved verbatim from scripts/complexity_energetics/generate_tables_and_numbers.py; thin wrapper retained for CLI compatibility."""
