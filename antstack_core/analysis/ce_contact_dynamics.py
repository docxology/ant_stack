"""Contact dynamics and terrain effects analysis. Moved verbatim from scripts/complexity_energetics/analyze_contact_dynamics.py; thin wrapper retained for CLI compatibility."""
