"""Generate biomechanical and robotic benchmarks for energy analysis. Moved verbatim from scripts/complexity_energetics/generate_biomechanical_benchmarks.py; thin wrapper retained for CLI compatibility."""
