"""Neural network connectivity, sparsity, and brain scaling analysis. Moved verbatim from scripts/complexity_energetics/analyze_neural_networks.py; thin wrapper retained for CLI compatibility."""
