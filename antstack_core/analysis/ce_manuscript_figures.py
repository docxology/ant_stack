"""Manuscript figure generation orchestrator. Moved verbatim from scripts/complexity_energetics/generate_manuscript_figures.py; thin wrapper retained for CLI compatibility."""
