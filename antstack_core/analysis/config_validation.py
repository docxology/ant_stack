"""Unified configuration validation for the Ant Stack analysis.

Moved verbatim from scripts/validate_unified_config.py; thin wrapper retained for CLI compatibility.
"""
...
class ConfigValidator:
    ...
    def __init__(self, project_root=None):
        self.project_root = project_root if project_root is not None else Path(__file__).resolve().parents[2]
