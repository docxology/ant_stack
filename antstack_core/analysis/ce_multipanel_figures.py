#!/usr/bin/env python3
"""Generate multipanel figures for the manuscript. Moved verbatim from scripts/complexity_energetics/generate_multipanel_figures.py; thin wrapper retained for CLI compatibility."""
