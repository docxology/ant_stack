"""Active inference complexity and scaling analysis. Moved verbatim from scripts/complexity_energetics/analyze_active_inference.py; thin wrapper retained for CLI compatibility."""
