"""Publication figure generation with comprehensive captions and auto-numbering. Moved verbatim from scripts/complexity_energetics/generate_publication_figures.py; thin wrapper retained for CLI compatibility."""
