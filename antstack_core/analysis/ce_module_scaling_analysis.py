"""Comprehensive analysis script for complexity and energetics research (module scaling). Moved verbatim from scripts/complexity_energetics/generate_comprehensive_analysis.py; thin wrapper retained for CLI compatibility."""
