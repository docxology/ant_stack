"""Results figure generation orchestrator. Moved verbatim from scripts/complexity_energetics/generate_results_figures.py; thin wrapper retained for CLI compatibility."""
