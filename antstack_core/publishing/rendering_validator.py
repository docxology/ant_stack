"""Comprehensive validation of the PDF rendering system. Moved verbatim from scripts/validate_rendering_system.py; thin wrapper retained for CLI compatibility."""
